...
- **WhatsApp Number Update (August 22, 2025)**: Updated WhatsApp business number from +919597201554 to +16195972011 (US Twilio number) across all contact points including footer, product enquiry buttons, and general messaging integrations
...
- **Enhanced WhatsApp Integration**: Updated WhatsApp number to US Twilio number (+16195972011), added WhatsApp enquiry buttons on all product cards, and enhanced product-specific enquiry messaging with detailed product information
